<x-template-mail>
    ...
    <div class="email-body">
        <p class="greeting">
            Your inspection order has been confirmed.
        ...
        <div style="margin: 20px 0;">
            <a href="https://{{ $_SERVER['SERVER_NAME'] }}/account/orders" class="button"
        ...
        <div class="small-note">
            ...
            Inspector will arrive 15 minutes before scheduled time
        </div>
    </div>
